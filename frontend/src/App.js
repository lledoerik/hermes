...
// Pàgines futures (desactivades de moment)
...
// Component per protegir rutes només per admins (per futures funcionalitats)
    ...
    <Router>
      <div className="app">
        ...
        <Routes>
          ...
          {/* Rutes futures desactivades de moment */}

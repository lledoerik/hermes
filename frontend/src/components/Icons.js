/**
 * Biblioteca d'icones SVG centralitzada
 * Totes les icones del projecte en un sol lloc per evitar duplicacions
 */

import React from 'react';

// === ICONES DE TIPUS DE CONTINGUT ===

export const MovieIcon = ({ size = 24 }) => (
...
export const SeriesIcon = ({ size = 24 }) => (
...
export const AudiobookIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const ProgramsIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const BookmarkIcon = ({ filled = false, size = 18 }) => (
...
// === ICONES DE REPRODUCCIÓ ===

export const FullscreenIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z"/>
  </svg>
);

export const FullscreenExitIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
export const VolumeIcon = ({ size = 24, muted = false }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    {muted ? (
...
export const LoadingIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="loading-spinner">
    <circle cx="12" cy="12" r="10" opacity="0.25"/>
    <path d="M12 2a10 10 0 0 1 10 10" strokeLinecap="round"/>
  </svg>
);

export const ErrorIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
export const EpisodesIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
export const PlayCircleIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
